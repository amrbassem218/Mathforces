...
const SideBar: React.FunctionComponent<ISideBarProps> = ({contest, handleContestEnd}) => {
  const guidelines = 
  [
  ...
  return (
    <div className='flex flex-col gap-5'>
      ...
      <Card className='border-border pt-1 gap-0'>
        <CardHeader className='text-xl font-semibold flex justify-center items-center my-1'>{contest.name}</CardHeader>
